...
const getMockResponse = (input, npcContext = {}) => {
  ...
  const roleResponses = {
    'Informant': {
      greeting: { text: "You don't look like one of them. I'm the Shadow Broker — former intel analyst, now freelance truth dealer. What brought you to this place?", reputationChange: 1 },
      mission: { text: "There's a classified dossier in the Server Room. Get it before they wipe it — it has names, dates, everything.", mission: { id: 'shadow_intel', title: 'Stolen Intelligence', description: 'Recover the classified dossier from the Server Room before it gets wiped.', status: 'ACTIVE' }, reputationChange: 2 },
    ...
    'Civilian': {
      greeting: { text: "Oh! You startled me... I'm the kitchen worker but I hear things — the guards talk when they think no one's listening. What brings you here?", reputationChange: 1 },
      mission: { text: "My brother was taken to the Command Center. Please find any sign of him! I'll tell you everything I know about guard schedules.", mission: { id: 'kitchen_rescue', title: 'Find My Brother', description: 'My brother is held somewhere in the Command Center. Please find any sign of him.', status: 'ACTIVE' }, reputationChange: 2 },
    ...
    'Hacker': {
      greeting: { text: "Call me Ghost — I make security systems cry for mercy. So are you just wandering, or do you actually have a plan?", reputationChange: 1 },
      mission: { text: "Plant my USB in the Security Office. I'll blind every camera for 5 minutes — that's your window.", mission: { id: 'hack_cameras', title: 'Disable Surveillance', description: 'Reach the Security Office and plug in my USB drive to disable all cameras for 5 minutes.', status: 'ACTIVE' }, reputationChange: 2 },
    ...
    'Guard Captain': {
      greeting: { text: "I'm Captain Ironjaw — 15 years in this place. You move like someone with a purpose. What do you want?", reputationChange: 1 },
      mission: { text: "Bring me proof of the Commander's illegal orders from the Command Center. I'll turn the guards against him.", mission: { id: 'captain_proof', title: 'Evidence of Corruption', description: "Bring me proof of the Commander's illegal orders from the Command Center.", status: 'ACTIVE' }, reputationChange: 2 },
    ...
    'Doctor': {
      greeting: { text: "I'm Dr. Voss — the compound medic. The things they ask me to do... go far beyond medicine. Are you someone I can trust?", reputationChange: 1 },
      mission: { text: "Biological samples in the Server Room — unethical experiments. Destroy them before they ship out tomorrow.", mission: { id: 'doctor_samples', title: 'Destroy the Samples', description: "There are biological samples in the restricted Server Room. Destroy them before they're shipped out.", status: 'ACTIVE' }, reputationChange: 2 },
    ...
    'Arms Dealer': {
      greeting: { text: "Name's Viper — I move things that aren't supposed to move. Weapons, supplies, info... everything has a price. What's yours?", reputationChange: 1 },
      mission: { text: "Simple job: pick up a package from Storage, bring it to me. No questions. I'll give you intel on the guard routes in return.", mission: { id: 'dealer_supply', title: 'Smuggle the Package', description: 'Pick up a package from the Storage room and bring it to me. No questions asked.', status: 'ACTIVE' }, reputationChange: 2 },
  ...
  if (isGreeting) return { ...mock.greeting, mission: null };
  if (aboutGuards) return { text: mock.guards, mission: null, reputationChange: 0 };
  if (aboutEscape) return { text: mock.escape, mission: null, reputationChange: 0 };
  if (aboutSecurity) return { text: mock.security, mission: null, reputationChange: 0 };
  return { text: mock.fallback, mission: null, reputationChange: 0 };
};
